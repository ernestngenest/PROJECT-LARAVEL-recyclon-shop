      ...
      <div class="collapse navbar-collapse p-2" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
              <li><a class="dropdown-item" href="/admin/viewitem">View Item </a></li>
              <li><hr class="dropdown-divider"></li>
              <li><a class="dropdown-item" href="/admin/addItem">Add Item</a></li>
            </ul>
          </li>
        <form class="d-flex" role="search">
          <input class="form-control me-2" style="width: 80em;" type="search" placeholder="Search" aria-label="Search" name="search">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><hr class="dropdown-divider"></li>
            <li><a class="dropdown-item" href="/edit_profile/{{ auth()->user()->id }}">Edit Profile</a></li>
            <li><hr class="dropdown-divider"></li>
